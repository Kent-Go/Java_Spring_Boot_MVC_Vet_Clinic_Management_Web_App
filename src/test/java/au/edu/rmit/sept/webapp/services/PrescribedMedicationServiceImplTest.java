...
@SpringBootTest
class PrescribedMedicationServiceImplTest {
        ...
        @Test
        void testGetPrescribedMedicationByAppointmentIDNoRecordsFound() {
        ...
        @Test
        void testGetPrescribedMedicationByAppointmentIDWithRecords() {
                int appointmentID = 1;
                ...
                List<PrescribedMedication> mockMedications = List.of(
                                new PrescribedMedication(1, 1, 1, "Take with food", mockMedicine.getId(), 1,
                                                appointmentID),
                                new PrescribedMedication(2, 2, 2, "Take with water", mockMedicine2.getId(), 2,
                                                appointmentID));
        ...
        @Test
        void testGetPrescribedMedicationByIDNoRecordFound() {
                int nonExistentID = 999;

                when(prescribedMedicationRepository.findById(nonExistentID))
                                .thenReturn(Optional.empty());

                PrescribedMedication medication = prescribedMedicationService
                                .getPrescribedMedicationByID(nonExistentID);
        ...
        @Test
        void testGetPrescribedMedicationByIDWithRecord() {
                int id = 1;
                Medicine mockMedicine = new Medicine(1, "Panadol", "100", "10.00");
                PrescribedMedication mockMedication = new PrescribedMedication(1, 1, 1, "Take with food",
                                mockMedicine.getId(),
                                1, 1);
                ...
                assertAll("medication",
                                ...
                                () -> assertEquals("Panadol", medication.getMedicine().getName(),
                                                "Medicine name should be 'Panadol'"),
                                () -> assertEquals("100", medication.getMedicine().getQuantity(),
                                                "Medicine quantity should be '100'"),
                                () -> assertEquals("10.00", medication.getMedicine().getPrice(),
                                                "Medicine price should be '10.00'"),
        ...
        @Test
        void testUpdatePrescribedMedication() {
                ...
                PrescribedMedication updatedMedication = prescribedMedicationService
                                .updatePrescribedMedication(medication);
        ...
        @Test
        void testSaveNewPrescribedMedication() {
                ...
                PrescribedMedication savedMedication = prescribedMedicationService
                                .updatePrescribedMedication(medication);
        ...
        @Test
        void testDeletePrescribedMedicationByID() {
                int id = 1;
