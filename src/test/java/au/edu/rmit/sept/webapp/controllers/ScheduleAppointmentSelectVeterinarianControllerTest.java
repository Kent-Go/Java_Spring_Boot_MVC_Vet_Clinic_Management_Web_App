...
class ScheduleAppointmentSelectVeterinarianControllerTest {
    ...
    void testShowVetForAppointmentTypeID1() throws Exception {
        ...
        Vet vet1 = new Vet("Dr.", "English, Russian, Italian", "Basic description for a vet... uh... I'm very good at taking care of dogs and cats??", 2);
        Vet vet2 = new Vet("Surgeon", "English, Spanish", "I have very steady hands and is skillful with knifes on the operating room", 4);
