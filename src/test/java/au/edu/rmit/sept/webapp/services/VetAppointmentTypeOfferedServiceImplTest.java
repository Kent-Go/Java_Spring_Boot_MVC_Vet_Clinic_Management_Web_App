...
@SpringBootTest
public class VetAppointmentTypeOfferedServiceImplTest {
    ...
    // type ID
    @Test
    public void testGetVetAppointmentTypeOfferedByAppointmentTypeIDWithRecords() {
    ...
    @Test
    public void testGetVetAppointmentTypeOfferedByAppointmentTypeIDNoRecordsFound() {
    ...
    @Test
    public void testGetVetAppointmentTypeOfferedByAppointmentTypeIDWithNullID() {
    ...
    @Test
    public void testGetVetAppointmentTypeOfferedByAppointmentTypeIDWithNegativeID() {
